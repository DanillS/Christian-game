...
create table public.guess_face_questions (
  ...
  full_image_url text, -- Полная фотография, откуда брали часть тела
...
4. Откройте бота в Telegram — автоматически отобразится главное меню с инлайн-кнопками
5. **Войдите в панель:**
   - Нажмите кнопку "🔐 Войти" в главном меню
   - Введите пароль из `TELEGRAM_ADMIN_PASSWORD`
6. **Используйте инлайн-кнопки для навигации:**
   - **👤 Угадай лицо** — добавление вопроса с двумя фотографиями (часть тела + полная фотография)
   - **🎵 Угадай мелодию** — добавление вопроса с аудиофайлом
   - **🎤 Угадай голос** — добавление вопроса с аудиофайлом голоса
   - **📖 Библейская цитата** — добавление вопроса с библейской цитатой
   - **🖼️ Добавить иконку** — обновление иконки раунда
...
5. **Используйте кнопку "📊 Статус"** в главном меню бота для проверки конфигурации.
